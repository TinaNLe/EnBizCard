...
export default {
  setup() {
    ...
    return { baseURL: config.app.baseURL, theme }
  },
  ...
  methods: {
    ...
    sharingAlert() {
      this.showAlert(
        `You are able to share your business card after completing the hosting process.\n\nCheck out the <a class="underline font-extrabold text-emerald-600 hover:text-emerald-500 transition-colors duration-200" href="${this.baseURL}/demo" target="_blank">demo</a> to test the functionality.`
      )
    },
    togglePlay(ref) {
